 ...
 */
#ifndef tesseract_planners_ros_examples_PUZZLE_PIECE_AUXILLARY_AXES_EXAMPLE_H
#define tesseract_planners_ros_examples_PUZZLE_PIECE_AUXILLARY_AXES_EXAMPLE_H
...
#endif  // tesseract_planners_ros_examples_PUZZLE_PIECE_AUXILLARY_AXES_EXAMPLE_H
