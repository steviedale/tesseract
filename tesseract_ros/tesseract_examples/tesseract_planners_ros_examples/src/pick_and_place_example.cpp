...
#include <tesseract_planners_ros_examples/pick_and_place_example.h>
...
bool PickAndPlaceExample::run()
{
  ...
  if (write_to_file_)
  {
    std::string path = ros::package::getPath("tesseract_planners_ros_examples") + "/file_output_pick.csv";
