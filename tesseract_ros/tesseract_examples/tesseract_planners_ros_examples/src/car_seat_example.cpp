    ...
    for (int m = 1; m <= 10; ++m)
    {
      std::vector<tesseract_geometry::Mesh::Ptr> meshes =
          tesseract_geometry::createMeshFromResource<tesseract_geometry::Mesh>(
              locator_->locateResource("package://tesseract_planners_ros_examples/"
...
//  visual_mesh(shapes::createMeshFromResource("package://tesseract_planners_ros_examples/meshes/car_seat/visual/car.dae"));
//  std::shared_ptr<shapes::Mesh>
//  collision_mesh(shapes::createMeshFromResource("package://tesseract_planners_ros_examples/meshes/car_seat/collision/car.stl"));
