...
#include <trajopt_ros_examples/car_seat_example.h>
...
namespace trajopt_ros_examples
{
...
void CarSeatExample::addSeats()
{
  for (int i = 0; i < 3; ++i)
  {
    ...
    visual->geometry =
        tesseract_geometry::createMeshFromResource<tesseract_geometry::Mesh>(locator_->locateResource("package://tesseract_support/meshes/car_seat/visual/seat.dae"),
    ...
    for (int m = 1; m <= 10; ++m)
    {
      std::vector<tesseract_geometry::Mesh::Ptr> meshes =
          tesseract_geometry::createMeshFromResource<tesseract_geometry::Mesh>(
              locator_->locateResource("package://tesseract_support/"
...
//  visual_mesh(shapes::createMeshFromResource("package://tesseract_support/meshes/car_seat/visual/car.dae"));
//  std::shared_ptr<shapes::Mesh>
//  collision_mesh(shapes::createMeshFromResource("package://tesseract_support/meshes/car_seat/collision/car.stl"));
