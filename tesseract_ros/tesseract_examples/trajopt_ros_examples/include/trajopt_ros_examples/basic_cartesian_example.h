 ...
 */
#ifndef TRAJOPT_ROS_EXAMPLES_BASIC_CARTESIAN_EXAMPLE_H
#define TRAJOPT_ROS_EXAMPLES_BASIC_CARTESIAN_EXAMPLE_H
...
#endif  // TRAJOPT_ROS_EXAMPLES_BASIC_CARTESIAN_EXAMPLE_H
