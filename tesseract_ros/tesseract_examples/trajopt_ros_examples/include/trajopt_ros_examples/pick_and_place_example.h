 ...
 */
#ifndef TRAJOPT_ROS_EXAMPLES_PICK_AND_PLACE_EXAMPLE_H
#define TRAJOPT_ROS_EXAMPLES_PICK_AND_PLACE_EXAMPLE_H
...
#endif  // TRAJOPT_ROS_EXAMPLES_PICK_AND_PLACE_EXAMPLE_H
