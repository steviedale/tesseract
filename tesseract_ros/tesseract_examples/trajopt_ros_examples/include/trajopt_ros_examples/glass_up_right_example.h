 ...
 */
#ifndef TRAJOPT_ROS_EXAMPLES_GLASS_UP_RIGHT_EXAMPLE_H
#define TRAJOPT_ROS_EXAMPLES_GLASS_UP_RIGHT_EXAMPLE_H
...
#endif  // TRAJOPT_ROS_EXAMPLES_GLASS_UP_RIGHT_EXAMPLE_H
